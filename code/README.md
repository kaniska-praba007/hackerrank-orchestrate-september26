...
### Main Execution
To run the full end-to-end pipeline on `dataset/requests.csv` and generate `<repo_root>/output.csv`:
...
Detailed token counts and per-request costs are documented in [`evaluation/usage_report.md`](./evaluation/usage_report.md).
